...
/*   Updated: 2022/02/03 16:12:20 by dokwak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"
int	get_malloc_size(long long dec, char *base_to)
{
	int			to_base_len;
	int			len_for_malloc;
	long long	temp;
...
int	ft_str_to_dec(char *nbr, char *base_from)
{
	int	ret;
	int	neg_pos;
...
char	*dec_to_base(long long nbr, char *base_to)
{
	int			malloc_size;
	int			i;
	char		*ret_str;
