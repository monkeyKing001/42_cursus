...
int main(int ac, char ** av)
{
	...
	TEST(20, print(" %d ", -100));
	TEST(21, print(" %d ", -101));
	TEST(22, print(" %d ", INT_MAX)); //pass
	TEST(23, print(" %d ", INT_MIN));
	TEST(24, print(" %d ", LONG_MAX));
	TEST(25, print(" %d ", LONG_MIN)); //pass
	TEST(26, print(" %d ", UINT_MAX));
	TEST(27, print(" %d ", ULONG_MAX));
	TEST(28, print(" %d ", 9223372036854775807LL));
	TEST(29, print(" %d %d %d %d %d %d %d", INT_MAX, INT_MIN, LONG_MAX, LONG_MIN, ULONG_MAX, 0, -42)); //<- fail
	cout << ENDL;
	return (0);
}
